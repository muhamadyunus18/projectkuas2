...
<div class="login-bg-animated">
    <div class="container d-flex justify-content-center align-items-center min-vh-100 position-relative" style="z-index:2;">
        <div class="card shadow-lg p-4 animate__animated animate__fadeInUp glass-card" style="border-radius: 1.5rem; min-width: 350px; max-width: 400px;">
            <h2 class="mb-4 text-center" style="font-weight: 700; letter-spacing: 1px; color: #fff;">Register User</h2>
            <form method="POST" action="{{ route('register') }}">
                @csrf
                <div class="mb-3">
                    <label for="name" class="form-label" style="font-weight: 500; color: #dfe6e9;">Nama</label>
                    <input type="text" class="form-control form-control-lg" id="name" name="name" required autofocus style="border-radius: 1rem; background: rgba(255,255,255,0.08); color: #fff; border: 1px solid #576574;">
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label" style="font-weight: 500; color: #dfe6e9;">Email</label>
                    <input type="email" class="form-control form-control-lg" id="email" name="email" required style="border-radius: 1rem; background: rgba(255,255,255,0.08); color: #fff; border: 1px solid #576574;">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="password_confirmation" class="form-label" style="font-weight: 500; color: #dfe6e9;">Konfirmasi Password</label>
                    <input type="password" class="form-control form-control-lg" id="password_confirmation" name="password_confirmation" required style="border-radius: 1rem; background: rgba(255,255,255,0.08); color: #fff; border: 1px solid #576574;">
                </div>
            ...
            <div class="text-center mt-3">
                <a href="{{ route('login') }}" class="text-decoration-none" style="color: #74b9ff; font-weight: 500;">
